        ...
        <div className="kaira-container max-w-4xl">
          ...
          <div className="py-10 space-y-10 text-sm text-black/80 font-medium leading-relaxed">
            <section className="space-y-3">
              ...
              <p>
                By accessing or purchasing from KAIIRA, you agree to be bound by the terms and conditions outlined below. Please read these terms carefully before placing an order.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                All logos, typography, graphics, product photography, and brand design elements on this site are the exclusive property of KAIIRA. Unauthorized copying or redistribution is strictly prohibited.
              </p>
            </section>
          </div>
        </div>
