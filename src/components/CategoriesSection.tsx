  ...
  return (
    <section id="categories" className="py-20 sm:py-28 bg-white border-t border-black/5">
      <div className="kaira-container">
        ...
        <Reveal className="flex flex-col items-center justify-center text-center mb-12 sm:mb-16 max-w-2xl mx-auto space-y-3 border-b border-black/5 pb-8">
        ...
        {isError ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10">
            {categories.map((category, idx) => (
              <Reveal key={category.id} delay={(idx % 4) * 90} strength="soft">
                <Link
